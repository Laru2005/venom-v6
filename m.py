...
bot = telebot.TeleBot('6716657851:AAFD0IPz-K-v7synQLLU3UzO1m2M-9hUhn0')
...
def clear_users_command(message):
    ...
    if user_id in admin_id:
        ...
        response = "𝐅𝐫𝐞𝐞 𝐦𝐞 𝐤𝐮𝐜𝐡 𝐧𝐡𝐢 𝐦𝐢𝐥𝐭𝐞 𝐡𝐚𝐢 𝐜𝐡𝐚𝐡𝐢𝐲𝐞 𝐭𝐨𝐡 𝐥𝐨𝐫𝐚 𝐥𝐚 𝐦𝐞𝐫𝐚 𝐁𝐮𝐲:- @luckysahu111 🙇."
    bot.reply_to(message, response)
...
def start_attack_reply(message, target, port, time):
    ...
    response = f"{username}, 𝐀𝐓𝐓𝐀𝐂𝐊 𝐒𝐓𝐀𝐑𝐓𝐄𝐃.🔥🔥\n\n𝐓𝐚𝐫𝐠𝐞𝐭: {target}\n𝐏𝐨𝐫𝐭: {port}\n𝐓𝐢𝐦𝐞: {time} 𝐒𝐞𝐜𝐨𝐧𝐝𝐬\n𝐌𝐞𝐭𝐡𝐨𝐝: 𝐕𝐈𝐏 𝐔𝐒𝐄𝐑 𝐎𝐅 @luckysahu111"
    bot.reply_to(message, response)
...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = ("🚫 Unauthorized Access! 🚫\n\nOops! 𝐋𝐔𝐍𝐃 𝐋𝐀 𝐌𝐄𝐑𝐀. 𝐃𝐌 𝐓𝐎 𝐁𝐔𝐘 𝐀𝐂𝐂𝐄𝐒𝐒:- @luckysahu111")
